    ...
    <div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-danger" type="reset"><i
                                        class="fas fa-trash mr-2"></i>Reset</button>
                    </form>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($res == TRUE) {
                ...
                $_SESSION['addCategory'] = '<div class="alert alert-success alert-dismissible fade show mt-2" role="alert">
            <i class="fas fa-user mr-2"></i>Data berhasil ditambahkan!<button type="button" class="close"
                ...
                $_SESSION['addCategory'] = '<div class="alert alert-danger alert-dismissible fade show mt-2" role="alert">
