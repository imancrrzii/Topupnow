      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 footer-links" data-aos="fade-up">
          ...
          <ul>
            ...
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo base_url; ?>about.php">Tentang Kami</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo base_url; ?>kategori.php">Kategori</a>
            </li>
            <li><i class="bx bx-chevron-right"></i> <a href="<?php echo base_url; ?>contact.php">Hubungi Kami</a></li>
          </ul>
        </div>
